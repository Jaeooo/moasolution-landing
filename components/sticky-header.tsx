...
const imgGroup = "http://localhost:3845/assets/bc1b85702629155e512708cb731da52c191d3e51.svg";
const logoScrolled = "/icons/logo.svg"; // 스크롤 후 플로팅 헤더 로고
    ...
    <div className="flex items-center justify-between w-full">
      <Link href="/" className="h-[30px] w-[150px] relative block">
        <img
          ...
          src={isScrolled ? logoScrolled : imgGroup}
        />
      </Link>
      <nav
        className={`hidden lg:flex items-center gap-[48px] text-base font-normal leading-[1.48] tracking-[-0.4px] transition-colors duration-300 ${
          isScrolled ? "text-[#0a0b0e]" : "text-white"
        }`}
      >
        <a 
      ...
      >
        <Button
          className={`h-auto rounded-full px-[26px] py-[12px] text-sm font-semibold transition-all duration-300 ${
            isScrolled
  ...
  return (
    ...
    >
      <div className="mx-auto w-full">
        <div
          className={`relative px-[60px] py-[20px] overflow-hidden ${
            isScrolled
