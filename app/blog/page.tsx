...
const arrowLeft = "/icons/arrow_left.svg";
const overflow = "/icons/overflow.svg";
const arrowRight = "/icons/arrow_right.svg";
        ...
        <div className="max-w-[1320px] mx-auto">
          ...
          <div className="flex gap-3 items-center justify-center">
            <div className="relative size-[30px]">
              <img alt="이전" className="block max-w-none size-full" src={arrowLeft} />
            </div>
            ...
            <div className="relative size-[30px]">
              <img alt="다음" className="block max-w-none size-full" src={overflow} />
            </div>
            <div className="flex items-center justify-center px-5 py-4 rounded-[14px]">
            ...
            <div className="flex items-center justify-center">
              <div className="flex-none rotate-180">
                <div className="relative size-[30px]">
                  <img alt="마지막" className="block max-w-none size-full" src={arrowRight} />
                </div>
              </div>
            </div>
          </div>
